...
from fedml.model.cv.cnn import CNN_DropOut, CNN_WEB, CNN_FashionMNIST
...
def create(args, output_dim):
    ...
    elif model_name == "cnn_web" and args.dataset == "svhn":
        logging.info("CNN_WEB + SVHN")
        model = CNN_WEB()
    elif model_name == "cnn_fashionMNIST" and args.dataset == "fashionMNIST":
        logging.info("CNN_FashionMNIST + fashionMNIST")
