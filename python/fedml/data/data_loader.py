...
from .SVHN.efficient_loader import efficient_load_partition_data_svhn
from .FashionMNIST.efficient_loader import efficient_load_partition_data_fashionMNIST
...
def load_synthetic_data(args):
    ...
    if dataset_name == "mnist":
        ...
        (
            ...
            test_data_local_dict,
            class_num,
        ) = load_partition_data_federated_emnist(args, args.dataset, args.data_cache_dir)
        args.client_num_in_total = client_num
        ...
        (
            ...
            test_data_local_dict,
            class_num,
        ) = load_partition_data_federated_shakespeare(args, args.dataset, args.data_cache_dir)
        args.client_num_in_total = client_num
        ...
        (
            ...
            test_data_local_dict,
            class_num,
        ) = load_partition_data_federated_cifar100(args, args.dataset, args.data_cache_dir)
        args.client_num_in_total = client_num
        ...
        if hasattr(args, "synthetic_data_url") or hasattr(args, "private_local_data"):
            ...
            (
                ...
                test_data_local_dict,
                class_num,
            ) = efficient_load_partition_data_svhn(
                args,
                args.dataset,
                args.data_cache_dir,
            ...
            data_loader = efficient_load_partition_data_svhn
        (
            train_data_num,
            test_data_num,
            train_data_global,
        ...
        if hasattr(args, "synthetic_data_url") or hasattr(args, "private_local_data"):
            ...
            (
                ...
                test_data_local_dict,
                class_num,
            ) = efficient_load_partition_data_fashionMNIST(
                args,
                args.dataset,
                args.data_cache_dir,
                args.partition_method,
            ...
            data_loader = efficient_load_partition_data_fashionMNIST
        (
            train_data_num,
            test_data_num,
            train_data_global,
