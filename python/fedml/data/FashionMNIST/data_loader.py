...
def read_data_distribution(
    filename="./data_preprocessing/non-iid-distribution/FashionMNIST/distribution.txt",
):
    distribution = {}
...
def read_net_dataidx_map(
    filename="./data_preprocessing/non-iid-distribution/FashionMNIST/net_dataidx_map.txt",
):
    net_dataidx_map = {}
    with open(filename, "r") as data:
        for x in data.readlines():
...
def load_fashionMNIST_data(datadir):
    ...
    fashionMNIST_train_ds = FashionMNIST_truncated(
        datadir, train=True, download=True, transform=train_transform
    )
    fashionMNIST_test_ds = FashionMNIST_truncated(
...
def partition_data(dataset, datadir, partition, n_nets, alpha):
    ...
    if partition == "homo":
        ...
        dataidx_map_file_path = (
            "./data_preprocessing/non-iid-distribution/FashionMNIST/net_dataidx_map.txt"
        )
        net_dataidx_map = read_net_dataidx_map(dataidx_map_file_path)

    if partition == "hetero-fix":
        distribution_file_path = (
            "./data_preprocessing/non-iid-distribution/FashionMNIST/distribution.txt"
        )
...
def get_dataloader_test(
    ...
    return get_dataloader_test_fashionMNIST(
...
def get_dataloader_test_fashionMNIST(
...
def load_partition_data_fashionMNIST(
    args,
    dataset,
    data_dir,
    partition_method,
